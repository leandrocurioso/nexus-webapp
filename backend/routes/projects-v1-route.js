...
class ProjectsV1Route {
    ...
    init() {
        this.app.get(`${ProjectsV1Route.BaseUri}`, this.getServices.bind(this));
        this.app.post(`${ProjectsV1Route.BaseUri}`, this.postService.bind(this));
        this.app.delete(`${ProjectsV1Route.BaseUri}/:id`, this.deleteService.bind(this));
        this.app.get(`${ProjectsV1Route.BaseUri}/:id`, this.getService.bind(this));
    }
...
export default ProjectsV1Route;
